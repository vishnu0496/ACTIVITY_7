...
// If current country is selected, fade out
return selectedCountries.includes(data[colorCol]) ? 0.2 : 1;
});
...
// If current category is selected, fade out
return selectedCountries.includes(category) ? 0.2 : 1;
});
